...
//START///////////////////////////////////////////////////////////////////////
     ...
     */
    lib.description = "Oracle IoT Cloud Service JavaScript Enterprise Client Software Library";
 ...
 *      device.someAction.onAction = function(response) {
 ...
 *      };
 *      device.power.onAction = function(value) {
 *          if (value) {
 *              //shutdown the device
 *          } else {
 *              //start the device
 *          }
 *      };
 *      device.reset.onAction = function() {
 *          //reset the device
 *          throw new Error('some message'); //if some error occurred
 *      };
 * }
...
//////////////////////////////////////////////////////////////////////////////
// file: ./src/enterprise/@globals.js
 ...
 * <br>
 * In the enterprise client library, this is the actual polling interval used for virtual device
 * monitoring, message monitoring, and async request response monitoring.
 * <br>
 * In the device client library, this is the minimum polling interval used by the MessageDispatcher
...
/**
 * The configuration variable used by the enterprise library, only in a browser environment, to get
...
//////////////////////////////////////////////////////////////////////////////
// file: ./src/enterprise/Platform-Node.js
...
/**
 * This Platform class supports handling the environment variables when running on NodeJS.  When
 * running in a browser, process.env is not available.  This file, and it's associated file,
 * PlatformBrowser must support the same environment variables.
 */
class Platform {
...
//////////////////////////////////////////////////////////////////////////////
// file: ./src/enterprise/$impl-ecl.js
    ...
    if (!$port.userAuthNeeded()) {
       ...
       Object.defineProperty(this._, 'createStorageObject', {
            ...
            value: function (arg1, arg2) {
                ...
                if (arg2 === undefined) {
                    console.log('Error: arg2 cannot be undefined.');
                }

                if ((typeof arg2 === "string") || (arg2 === null)) {
                    // createStorageObject(name, type)
                    return new lib.StorageObject(undefined, arg1, arg2, undefined, undefined,
                       undefined);
                } else {
...
lib.enterprise.EnterpriseClient.prototype.createStorageObject = function (arg1, arg2) {
    ...
    if ((typeof arg2 === "string") || (arg2 === undefined) || (arg2 === null)) {
        // createStorageObject(name, type)
       var storage = new lib.enterprise.StorageObject(null, arg1, arg2, null, null, null);
...
lib.enterprise.VirtualDevice = function (endpointId, deviceModel, client) {
     ...
     */
    Object.defineProperty(this, 'createAction', {
        enumerable: true,
        configurable: false,
    ...
    this._.createAction = function (arg) {};
    this._.onData = function (arg) {};
    var self = this;
...
lib.enterprise.VirtualDevice.prototype.call = function (actionName, arg) {
    ...
    this.controller.invokeSingleArgAction(action.name, arg);
};
 ...
 * @private
 */
lib.enterprise.VirtualDevice.prototype.callMultiArgAction = function (actionName, args) {
    ...
    this.controller.invokeMultiArgAction(action.name, args);
};
 ...
 *
 * @function getCustomMetadata
 * @memberof iotcs.enterprise.StorageObject.prototype
 */
lib.enterprise.StorageObject.prototype.getCustomMetadata = function() {
   return this._.internal.metadata;
};
 ...
 * @memberof iotcs.enterprise.StorageObject.prototype
 */
lib.enterprise.StorageObject.prototype.setCustomMetadata = function(key, value) {
   if (!key || (key.length < 1) || !value || (value.length < 1)) {
      lib.error('key and value must be non-empty strings.');
   }

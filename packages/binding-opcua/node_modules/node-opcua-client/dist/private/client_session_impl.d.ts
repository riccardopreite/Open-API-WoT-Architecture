...
export declare class ClientSessionImpl extends EventEmitter implements ClientSession {
     ...
     * @param callback
     */
    readHistoryValue(nodes: NodeIdLike[], start: DateTime, end: DateTime, callback: (err: Error | null, results?: HistoryReadResult[]) => void): void;
    readHistoryValue(nodes: NodeIdLike[], start: DateTime, end: DateTime): Promise<HistoryReadResult[]>;
    readHistoryValue(node: NodeIdLike, start: DateTime, end: DateTime, callback: (err: Error | null, results?: HistoryReadResult) => void): void;
    readHistoryValue(nodes: NodeIdLike, start: DateTime, end: DateTime): Promise<HistoryReadResult>;
    /**

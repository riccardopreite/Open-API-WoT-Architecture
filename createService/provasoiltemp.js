...
provasoiltemp: function provasoiltemp(){
	return new Promise(async (resolve, reject) => {
		if( soilGridsAPIsoil_temperature == soilGridsAPIsoil_temperature && ambeesoilAPIsoil_temperature == ambeesoilAPIsoil_temperature ){
			let thenVal = await createService.printLcd(soilGridsAPIsoil_temperature); 
			resolve(thenVal)
		} 
		else{
